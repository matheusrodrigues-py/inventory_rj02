...
function normalizeText(value) {
  ...
  const replacements = [
    ...
    ['saud�vel', 'saudável'], ['aten��o', 'atenção'], ['Aten��o', 'Atenção'],
    ['cr�tica', 'crítica'], ['Cr�tica', 'Crítica'], ['Cr�tico', 'Crítico'],
    ['pend�ncia', 'pendência'], ['Pend�ncia', 'Pendência'], ['pend�ncias', 'pendências'], ['Pend�ncias', 'Pendências'],
    ['manuten��o', 'manutenção'], ['Manuten��o', 'Manutenção'],
    ['invent�rio', 'inventário'], ['Invent�rio', 'Inventário'],
    ['dispon�vel', 'disponível'], ['Dispon�vel', 'Disponível'], ['dispon�veis', 'disponíveis'], ['Dispon�veis', 'Disponíveis'],
    ['devolu��o', 'devolução'], ['Devolu��o', 'Devolução'], ['devolu��es', 'devoluções'], ['Devolu��es', 'Devoluções'],
    ['requisi��o', 'requisição'], ['Requisi��o', 'Requisição'], ['requisi��es', 'requisições'], ['Requisi��es', 'Requisições'],
    ['usu�rio', 'usuário'], ['Usu�rio', 'Usuário'], ['usu�rios', 'usuários'], ['Usu�rios', 'Usuários'],
    ['relat�rio', 'relatório'], ['Relat�rio', 'Relatório'], ['relat�rios', 'relatórios'], ['Relat�rios', 'Relatórios'],
    ['configura��o', 'configuração'], ['Configura��o', 'Configuração'], ['configura��es', 'configurações'], ['Configura��es', 'Configurações'],
    ['l�der', 'líder'], ['L�der', 'Líder'], ['l�deres', 'líderes'], ['L�deres', 'Líderes'],
    ['utiliza��o', 'utilização'], ['Utiliza��o', 'Utilização'],
    ['estrat�gico', 'estratégico'], ['r�pida', 'rápida'], ['opera��es', 'operações'],
    ['localiza��o', 'localização'], ['per�odo', 'período'], ['M�dia', 'Média'],
    ['Priorit�ria', 'Prioritária'], ['a��o', 'ação'], ['A��o', 'Ação'], ['a��es', 'ações'], ['A��es', 'Ações'],
    ['an�lise', 'análise'], ['An�lise', 'Análise'], ['s�rie', 'série'], ['n�mero', 'número'],
    ['est�', 'está'], ['n�o', 'não'], ['pr�ximo', 'próximo'], ['Necess�rios', 'Necessários'],
    ['R�dio', 'Rádio'], ['r�dio', 'rádio'], ['Ambulat�rio', 'Ambulatório'], ['Recep��o', 'Recepção'],
  ];
  replacements.forEach(([broken, fixed]) => { text = text.split(broken).join(fixed); });
  return text.replace(/\s�\s/g, ' · ').replace(/�/g, '');
}
function escapeHtml(value) { return normalizeText(value).replace(/[&<>"']/g, (c) => ({ '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' }[c])); }
